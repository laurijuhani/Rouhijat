...
export default function Component({ status }: ComponentProps) {
  ...
  const title = isSuccess ? "Your request was completed!" : "Your request failed!";
  const description = isSuccess ? "It demonstrates that the task or request has been processed." : "There was an error processing your request.";
